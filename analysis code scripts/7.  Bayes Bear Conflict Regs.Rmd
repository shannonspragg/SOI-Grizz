...
warp.df <- st_read("/Users/shannonspragg/SOI-Grizz/Data/processed/warp.final.shp")
str(warp.df)

# Bring in our P(General Conflict) Raster for Extraction:
prob.gen.conf.rast <- terra::rast("/Users/shannonspragg/SOI-Grizz/Data/processed/prob_general_conf.tif")
...
dist2pa.rast <- terra::rast("/Users/shannonspragg/SOI-Grizz/Data/processed/dist2pa_SOI_10km.tif" )

  # Dist to Grizzly Populations:
dist2grizzpop.rast <- terra::rast("/Users/shannonspragg/SOI-Grizz/Data/processed/dist2grizz_pop_raster.tif")

  # Animal & Meat Farming Density:
animal.farming.rast <- terra::rast("/Users/shannonspragg/SOI-Grizz/Data/processed/animal_production_density_raster.tif")
...
ground.crop.rast <- terra::rast("/Users/shannonspragg/SOI-Grizz/Data/processed/ground_crop_density_raster.tif")
  ...
  # Grizzinc:
grizzinc.rast <- terra::rast("/Users/shannonspragg/SOI-Grizz/Data/processed/grizz_inc_SOI_10km.tif")

  # Bear Density - Bear Habitat Suitability (BHS):
bhs.rast <- rast("/Users/shannonspragg/SOI-Grizz/Data/processed/bhs_SOI_10km.tif")

  # Biophysical Current Map (Cumulative current flow shows the total current for each landscape pixel):
biophys.rast <- rast("/Users/shannonspragg/SOI-Grizz/Data/processed/biophys_SOI_10km.tif") # use this one

# CCS Region ID:
ccs.varint.means.rast.co <- rast("/Users/shannonspragg/SOI-Grizz/Data/processed/CCS_varint_raster_co.tif")
...
st_write(warp.df, "/Users/shannonspragg/SOI-Grizz/Data/processed/warp_df_complete.shp")
warp.df <- st_read("/Users/shannonspragg/SOI-Grizz/Data/processed/warp_df_complete.shp")
```
...
mini.warp.df.co <- data.frame(bears_presence_co, dist.2.pa.co, dist.2.grizzpop.co, animal.farm.dens.co, ground.crop.dens.co, grizzinc.co, bhs.co, biophys.co, CCSNAME.co, prob.gen.conf )
str(mini.warp.df.co)
```
...
post.co.no.offset <- stan_glmer(bears_presence_co ~ dist.2.pa.co + dist.2.grizzpop.co + animal.farm.dens.co + ground.crop.dens.co + grizzinc.co + biophys.co + bhs.co + (1 | CCSNAME.co) + prob.gen.conf, 
                             data = mini.warp.df.co,
                             family = binomial(link = "logit"), # define our binomial glm
...
post.co.partial.offset <- stan_glmer(bears_presence_co ~ dist.2.pa.co + dist.2.grizzpop.co + animal.farm.dens.co  + grizzinc.co + biophys.co + bhs.co + (1 | CCSNAME.co) + offset(prob.gen.conf), 
                             data = mini.warp.df.co,
                             family = binomial(link = "logit"), # define our binomial glm
                             prior = t_prior, prior_intercept = int_prior, QR=TRUE,
                             iter = 5000, # Run for enough iterations to avoid errors
...
saveRDS(post.co.offset, file = "/Users/shannonspragg/SOI-Grizz/Data/processed/post_co_offset.rds")
saveRDS(post.co.int, file = "/Users/shannonspragg/SOI-Grizz/Data/processed/post_co_int.rds")
saveRDS(post.co.no.offset, file = "/Users/shannonspragg/SOI-Grizz/Data/processed/post_co_no_offset.rds")
saveRDS(post.co.partial.offset, file = "/Users/shannonspragg/SOI-Grizz/Data/processed/post_co_partial_offset.rds")

# Restore the object
post.co.offset <- readRDS(file = "/Users/shannonspragg/SOI-Grizz/Data/processed/post_co_offset.rds")
post.co.no.offset <- readRDS(file = "/Users/shannonspragg/SOI-Grizz/Data/processed/post_co_no_offset.rds")
post.co.partial.offset <- readRDS(file = "/Users/shannonspragg/SOI-Grizz/Data/processed/post_co_partial_offset.rds")
post.co.int <- readRDS(file = "/Users/shannonspragg/SOI-Grizz/Data/processed/post_co_int.rds")
```
...
loo.comparison.co
  ...
  # Save these:
saveRDS(loo.co.offset, file = "/Users/shannonspragg/SOI-Grizz/Data/processed/loo_co_offset.rds")
saveRDS(loo.0.co, file = "/Users/shannonspragg/SOI-Grizz/Data/processed/loo_co_int.rds")
saveRDS(loo.no.offset, file = "/Users/shannonspragg/SOI-Grizz/Data/processed/loo_co_no_offset.rds")
```
...
# Save this as data:
saveRDS(kfold.10.co, file = "/Users/shannonspragg/SOI-Grizz/Data/processed/post_co_kfold10.rds")
saveRDS(kfold.10.co.int, file = "/Users/shannonspragg/SOI-Grizz/Data/processed/post_co_int_kfold10.rds")
saveRDS(kfold.10.no.offset.co, file = "/Users/shannonspragg/SOI-Grizz/Data/processed/post_co_no_offset_kfold10.rds")
saveRDS(kfold.10.partial.offset.co, file = "/Users/shannonspragg/SOI-Grizz/Data/processed/post_co_partial_kfold10.rds")
saveRDS(kfold.co.compare, file = "/Users/shannonspragg/SOI-Grizz/Data/processed/kfold_compare_co.rds")

# Recover the k-fold results:
kfold.10.co <- readRDS(file = "/Users/shannonspragg/SOI-Grizz/Data/processed/post_co_kfold10.rds")
kfold.10.co.int <- readRDS(file = "/Users/shannonspragg/SOI-Grizz/Data/processed/post_co_int_kfold10.rds")
...
soi.ccs.crop <- st_read( "/Users/shannonspragg/SOI-Grizz/Data/processed/SOI_CCS_10km.shp")
# Bring in one of our rasters for rasterizing polygon data later:
soi.rast <- terra::rast("/Users/shannonspragg/SOI-Grizz/Data/processed/SOI_10km.tif") # SOI Region 10km
...
terra::writeRaster(ccs.varint.means.rast.co, "/Users/shannonspragg/SOI-Grizz/Data/processed/CCS_varint_raster_co.tif" )
ccs.varint.means.rast.co <- rast("/Users/shannonspragg/SOI-Grizz/Data/processed/CCS_varint_raster_co.tif")
```
...
terra::writeRaster(p_BEAR_conf_offset_rast, "/Users/shannonspragg/SOI-Grizz/Data/processed/prob_bear_conflict.tif")
```
