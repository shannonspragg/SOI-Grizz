...
post.co.no.offset <- stan_glmer(bears_presence_co ~ dist.2.pa.co + dist.2.grizzpop.co + animal.farm.dens.co + ground.crop.dens.co + grizzinc.co + biophys.co + bhs.co + (1 | CCSNAME.co) + prob.gen.conf + I(prob.gen.conf), 
                             data = mini.warp.df.co,
                             family = binomial(link = "logit"), # define our binomial glm
