...
loo.comparison.co <- loo_compare(loo.0.co, loo.co.no.offset, loo.co.offset) # this high negative value for post0 shows us the covariates contain clearly useful information for predictions
loo.comparison.co

  # Save these:
saveRDS(loo.co.offset, file = "/Users/shannonspragg/SOI-Grizz/Data/processed/post_co_offset.rds")
saveRDS(loo.0.co, file = "/Users/shannonspragg/SOI-Grizz/Data/processed/post_co_int.rds")
saveRDS(loo.no.offset, file = "/Users/shannonspragg/SOI-Grizz/Data/processed/post_co_no_offset.rds")
```
