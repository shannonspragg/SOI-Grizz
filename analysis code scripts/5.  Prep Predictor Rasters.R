...
dist.pa.crop <- terra::crop(dist.pa.raster, vect(soi.10k.boundary), mask=TRUE)
dist.met.crop <- terra::crop(dist.met.raster, vect(soi.10k.boundary), mask=TRUE)
dist.griz.pop.crop <- terra::crop(dist.pa.raster, vect(soi.10k.boundary), mask=TRUE)
animal.prod.crop <- terra::crop(animal.prod.rast, vect(soi.10k.boundary), mask=TRUE)
ground.crop.crop <- terra::crop(ground.crop.rast, vect(soi.10k.boundary), mask=TRUE)
combined.crop <- animal.prod.crop + ground.crop.crop

terra::writeRaster(dist.pa.crop, "Data/processed/dist2pa_SOI_10km.tif")
terra::writeRaster(dist.met.crop, "Data/processed/dist2metro_SOI_10km.tif" )
terra::writeRaster(dist.griz.pop.crop, "Data/processed/dist2grizz_pop_raster.tif" )
